            ...
            <div class="m-0">
                ...
                <div class="d-flex align-items-center mb-2">
                    ...
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold text-dark">Installed Packages and their version numbers</span>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="m-0">
                            ...
                            <?php 
                                ...
                                //   echo "<pre/>";{{$afreen!=''?$afreen->businessphototitle5:''}}
    ...
    <div class="card card-flush">
        ...
        <div class="card-header py-7">
            ...
            <div class="m-0">
                ...
                <div class="d-flex align-items-center mb-2">
                    <!--begin::Title-->
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold text-dark">System Environment</span>
                        <span class="text-muted mt-1 fw-semibold fs-7"></span>
                    </h3>
                    <!--end::Title-->
                    <!--begin::Label-->
        ...
        <div class="card-body card-body d-flex justify-content-between flex-column pt-3">
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                    <div class="me-5">
                        <a class="text-gray-800 fw-bold text-hover-primary fs-6">Framework Version:</a>
                    </div>
        ...
        <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="m-0">
                            ...
                            ?>
                            <!-- if(in_array('debugmode',$DataArrayd)){
                                echo "<b><p> &#9989;</p></b>";
                                }else{
                                echo "<b><p> &#x274C;</p></b>";
                                } -->
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                    <div class="me-5">
                        <a class="text-gray-800 fw-bold text-hover-primary fs-6">Cache Dir Writable:</a>
                    </div>
                    <div class="d-flex align-items-center">
                        <div class="m-0">
                            <span class='fs-base'>
